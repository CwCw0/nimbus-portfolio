      ...
      <div className="flex w-full flex-col overflow-x-hidden bg-[var(--color-bg-primary)]">
        ...
        <section className="snap-section relative w-full px-16 pt-[100px] pb-[80px] max-md:px-6 max-md:pt-16 max-md:pb-12">
          <div className="flex flex-col gap-6 max-w-[900px]">
            ...
            <h1 className="font-display text-[64px] leading-[1.05] tracking-[-2px] text-[var(--color-text-primary)] max-md:text-[36px]">
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="flex flex-1 flex-col gap-6">
                  ...
                  <h3 className="font-display text-[32px] tracking-[-1px] text-[var(--color-text-primary)] max-md:text-2xl">
                    {service.title}
                  </h3>
