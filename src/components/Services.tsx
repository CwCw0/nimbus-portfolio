...
const services = [
  {
    ...
    desc: "Websites that load fast, rank well, and convert visitors into customers. From single landing pages to multi-page platforms.",
  ...
  },
  {
    ...
    icon: Palette,
    title: "Visual Design",
    desc: "Colour systems, typography, and component design that give your product a look nobody else has.",
    tags: ["Design Systems", "In-Code Design", "Brand"],
  ...
  },
  {
    ...
    icon: Layers,
    title: "UI/UX Design",
    desc: "Interfaces that feel obvious on first use. Research the user, map the journey, design every screen with purpose.",
  ...
  },
  {
    ...
    desc: "Custom AI agents, LLM-powered tools, and automation workflows. Your business runs while you sleep.",
