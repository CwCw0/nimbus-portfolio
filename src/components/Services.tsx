...
const services = [
  {
    ...
    desc: "The full build — website, operations layer, admin dashboard, and integrations. One system that handles your inventory, orders, and customers. Not just a site.",
  ...
  },
  {
    ...
    desc: "Colour systems, typography, and component libraries designed directly in code. What you see in preview is what ships.",
    tags: ["In-Code Design", "Tailwind", "Brand"],
  ...
  },
  {
    ...
    icon: Layers,
    title: "UI/UX Design",
    desc: "Interfaces that feel obvious on first use. Map the user journey, design every screen with purpose, test until it holds.",
    tags: ["Prototyping", "User Research", "Component Design"],
    size: "normal" as const,
  },
  {
    num: "04",
    ...
    desc: "Sites built fast from the ground up — Core Web Vitals, semantic HTML, and technical SEO baked in, not bolted on.",
  ...
  },
  {
    ...
    desc: "Custom AI agents, automation workflows, and LLM-powered tools built into your system. Not a chatbot add-on — AI that handles the business logic.",
    tags: ["Claude", "RAG", "Automation"],
    size: "wide" as const,
  },
];
